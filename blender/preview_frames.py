...
preview_dir = os.path.join(ROOT, "blender", "renders", "preview")
os.makedirs(preview_dir, exist_ok=True)
scene.render.image_settings.file_format = 'PNG'

print("FRAMES:", scene.frame_start, "-", scene.frame_end)
preview_frames = sorted(set([1, 20, 44, 60, 70, 80, 97, 120, scene.frame_end]))
print("PREVIEW_FRAMES:", preview_frames)
